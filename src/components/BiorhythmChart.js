    ...
    return (
        <ResponsiveContainer width="100%" height={200}>
            <LineChart data={data}>
                ...
                <Line dot={false} type="monotone" dataKey="physical" stroke="blue"/>
                <Line dot={false} type="monotone" dataKey="emotional" stroke="red"/>
                <Line dot={false} type="monotone" dataKey="intellectual" stroke="green"/>
            </LineChart>
        </ResponsiveContainer>
